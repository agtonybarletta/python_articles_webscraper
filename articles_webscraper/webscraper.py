...
#base_url = base_url='https://www.averagesearchengine.com/seach?'
base_url = base_url='https://www.google.com/seach?'
lan = 'en'
...
class LinkScaper:
    ...
    def __iter__(self):
        ...
        self.driver.get(url)
        self.links =self.driver.find_elements_by_css_selector('.r a')
        return self

    def __next__(self):
        if self.i >= self.n_articles:
            raise StopIteration
